...
int main()
{
	...
	add_course(DB, 20171, 11113, C5);
	add_course(DB, 20171, 11113, C7);
	add_course(DB, 20171, 11113, C4);
	print_student_semester_courses(DB, 20171, 11112);

	remove_student(DB, 11111);

	add_course(DB, 20172, 11113, C8);
	add_course(DB, 20172, 11113, C3);
	add_course(DB, 20172, 11113, C5);
	add_course(DB, 20172, 11113, C1);
	print_student_semester_courses(DB, 20172, 11112);
