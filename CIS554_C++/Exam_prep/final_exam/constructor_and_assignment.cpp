...
LinkedList LinkedList::operator=(LinkedList&& L) {//operator=; move assignment
    ...
    cout << "move assigment , and address is" << &L <<endl;
    return *this;
}
...
LinkedList::LinkedList(LinkedList&& L):LinkedList(){// move constructor
    head = L.head;
    L.head = nullptr;
...
int main() {
	...
	LinkedList L4{ 1,2,3, 4, 6 };//initialilizer_list
